<template>
  ...
  <div class="container" >
    <div class="row ">
        <div class="col-12"  id="color-form" style="margin-top:-50px;">
          <h1 class="" style="padding-top:-700px; color:;" id="form-d"> MOT DU PRESIDENT</h1>
    ...
    <div class="row">
        <div class="col-lg-4 col-md-6 mb-4" style="margin-top:-0px;">
          <div class="" style="padding:auto;">
              <div class="">
                <a href="#" class="">
                    <img loading="lazy" class="img-fluid" src="../../../public/Urls/images/news/news4.jpg" alt="img">
                </a>
              </div>
...
<p>les étudiants sortis de nos écoles trouvent difficilement un stage ou un emploi parce les
